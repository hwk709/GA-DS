...
7. [Student Expectations](#expectations)
8. [Class Resources](#Resources)

---
<a id='links'></a>
## Helpful Links

### <img src="https://d24cgw3uvb9a9h.cloudfront.net/static/94085/image/new/ZoomLogo.png" width="20px"> Zoom
Click here to attend class: [Zoom link](https://generalassembly.zoom.us/j/92417163041?pwd=NDl1VUZIOUx5aC9HOTdmSmtUaEpFUT09)
...
We'll use Slack for our main class communications platform. Use it anytime you want to share information about the course, discuss lessons, and/or submit projects. Our Slack classroom can be found [here](https://dsfundamentals.slack.com/archives/G01HJ2F8AAK).

### Exit Ticket
We thrive on feedback! Fill this out after each class: [Post-class Exit Ticket](https://www.surveymonkey.com/r/QL8586V?Cohort_ID=BAH115-ONLINE-DAT-D-007351)
...
>1. Let the Instructional Team member know in advance what you'd like to discuss via slack prior to the meeting. If multiple people are having similar issues we may setup a group session or bring some additional material to class
>2. Students are encouraged to come prepared with specific questions and the things they’ve tried so far so the instructional team can provide progressive suggestions and make the most of your time.
...
- **Alex's Office Hours** - https://calendly.com/alexandre-chicotelarregola/bah-officehours 
- **Kelvin's Office Hours** - https://kelvinsumlin.youcanbook.me/
- **Greg's Office Hours** - https://calendly.com/gregswanson/one-tim-appt?month=2020-11
...
### Python Version
The curriculum materials for this course are written in [Python 3.7](https://www.anaconda.com/distribution/).

---
<a id='team'></a>
## Your Instructional Team

**Instructor**: [Kevin McCullough](kevin.mccullough@generalassemb.ly)

**Instructional Associates**: 
+ Alexandre Chicote - [Linkedin](https://www.linkedin.com/in/alexchicote/)
+ Greg Swanson - [Linkedin](https://www.linkedin.com/in/greg-swanson-786bb684/)
+ Kelvin Sumlin - [Linkedin](https://www.linkedin.com/in/kelvinsumlin/)
...
--- |  --- | ---  | ---  |
1/11 |[Welcome to Data Science][1-1A] <br>**ISL:** Ch 2.1                 | Unit 1 | Session 1 |
1/13 |[Your Development Environment][1-1B]            | Unit 1 | Session 2 | 
1/18 |No Class           | |  |
1/20 |[Python Foundations][1-1C]                      | Unit 1 | Session 3 |  
1/25 | [Unit 1 Recap & Project Day][2-1A] <br>**Milestone:** [Unit 1 Project DUE - 11:59pm][2-1A]      | Unit 1 | Session 4 | 

## Unit 2: Working with Data
Date  |  Lesson  | Unit Number | Session Number |
--- |  --- | ---  | ---  |
1/27 |[Exploratory Data Analysis in Pandas][1-1E] <br>**Milestone:** [Capstone Project: Project Proposal DUE][2-1D] | Unit 2 | Session 5 | 
2/1 | [Data Visualization in Python][1-1G]   | Unit 2 | Session 6 | 
2/3 | [Statistics in Python][1-1H]               | Unit 2 | Session 7 | 
2/8 | [Experiments & Hypothesis Testing][1-1F] <br>**Milestone:** [Unit 2 Project DUE][2-1B] | Unit 2 | Session 8 | 


## Unit 3: Data Science Modeling
Date  |  Lesson  | Unit Number | Session Number |
--- |  --- | ---  | ---  |
2/10 | [Linear Regression][1-1J] <br>**ISL:** Ch 3.1-3, 3.5, 6.1,6.2 <br>**Milestone:** [Capstone Project: Exploratory Data Analysis DUE][2-1D]| Unit 3 | Session 9 | 
2/15 | No Class        | | | 
2/17 |  [Train-Test Split & Bias-Variance][1-1K] <br>**ISL:** Ch 2.2       | Unit 3 | Session 10 | 
2/22 |  [Feature Selection][1-1X]       | Unit 3 | Session 11 | 
2/24 | [KNN and Classification][1-1L]                    | Unit 3 | Session 12 | 
3/1 | [Clustering][1-1XZ]         | Unit 3 | Session 13 | 
3/3 |  [Logistic Regression][1-1M]  <br>**ISL:** Ch 4.1-3                    | Unit 3 | Session 14 | 
3/8  | [Decision Trees & Random Forests][Flex2] <br>**Milestone:** [Unit 3 Project DUE][2-1C] | Unit 3 | Session 15 | 

## Unit 4: Data Science Applications - Final Topics TBD
Date  |  Lesson  | Unit Number | Session Number |
--- |  --- | ---  | ---  |
3/10 | [Intro to Time Series][1-1Q]   | Unit 4 | Session 16 | 
3/15 | [Bayes][Flex1]               | Unit 4 | Session 17 | 
3/17 | [Intro to Natural Language Processing][1-1P]          | Unit 4 | Session 18 | 
3/22 | [Final Project Presentations][1-1T]  <br>**Milestone:** [Capstone Project DUE][1-1T] | Unit 4 | Session 19 | 
3/24 | [Final Project Presentations][1-1T]             | Unit 4 | Session 20 | 


[1-1A]: https://git.generalassemb.ly/dat-wave-13/02_welcome-to-data-science
[1-1B]: https://git.generalassemb.ly/dat-wave-13/03_your-development-environment
[1-1C]: https://git.generalassemb.ly/dat-wave-13/04_python-foundations

[1-1E]: https://git.generalassemb.ly/dat-wave-13/05_exploratory-data-analysis
[1-1F]: https://git.generalassemb.ly/dat-wave-13/08_experiments-hypothesis-tests
[1-1G]: https://git.generalassemb.ly/dat-wave-13/06_data-visualization-in-python
[1-1H]: https://git.generalassemb.ly/dat-wave-13/07_statistics-in-python

[1-1J]: https://git.generalassemb.ly/dat-wave-13/09_linear-regression
[1-1K]: https://git.generalassemb.ly/dat-wave-13/11_train-test-split-and-bias-variance
[1-1L]: https://git.generalassemb.ly/dat-wave-13/12_knn-classification
[1-1M]: https://git.generalassemb.lydat-wave-13/10_logistic-regression

[1-1O]: https://git.generalassemb.ly/dat-wave-13/15_getting-data-APIs
[1-1P]: https://git.generalassemb.ly/dat-wave-13/13_natural-language-processing
[1-1Q]: https://git.generalassemb.ly/dat-wave-13/14_time-series

[1-1T]: https://git.generalassemb.ly/dat-wave-13/unit-4-project
[1-1X]: https://git.generalassemb.ly/dat-wave-13/miscellaneous
[1-1XZ]: https://git.generalassemb.ly/dat-wave-13/flex_clustering

[Flex1]: https://git.generalassemb.ly/dat-wave-13/flex-bayes
[Flex2]: https://git.generalassemb.ly/dat-wave-13/flex_decision-trees



**ISL**: James, Gareth et al. "An Introduction to Statistical Learning." [[PDF](https://statlearning.com/)]
...
1. [Project 1: Python Technical Code Challenges][2-1A] (Due 1/25)
2. [Project 2: Exploratory Data Analysis][2-1B] (Due 2/8)
3. [Project 3: Modeling Practice][2-1C] (Due 3/8)
4. [Capstone Project: Professional or Personal Passion][2-1D]
    - Part 1: Proposal + Dataset (Due 1/27)
    - Part 2: Initial EDA Brief (Due 2/10)
    - Part 3: Solution Prototype (Due 3/22)
    - Part 4: Presentation (Due 3/22)
    
[2-1A]:  https://git.generalassemb.ly/dat-wave-13/unit-1-project
[2-1B]:  https://git.generalassemb.ly/dat-wave-13/unit-2-project
[2-1C]:  https://git.generalassemb.ly/dat-wave-13/unit-3-project
[2-1D]:  https://git.generalassemb.ly/dat-wave-13/unit-4-project
...
We'll use Slack for our class communications platform. Slack is a messaging platform where you can chat with your peers and instructors. We will use Slack to share information about the course, discuss lessons, and submit projects. Our Slack homepage is [wave8-dsf-mountain](https://dsfundamentals.slack.com).
...
4. Miss no more than 2 classes
5. Complete all unit assessments, final project and course surveys
6. *Ask questions* - it's the essence of being a good data scientist (and student)
7. Dedicate *2-3 hours* following every class to practice, complete unit projects and work on your capstone
8. Grow first by asking yourself "have I done all I can to answer this question - am I truly stuck?" before asking others.
